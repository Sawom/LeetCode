...
n + rob1 => বর্তমান বাড়ি নিলে ঠিক আগের বাড়ি স্কিপ দিতেই হবে, তাই ২ ঘর আগের মান (rob1) যোগ হয়।
rob2 => বর্তমান বাড়ি স্কিপ দিলে ঠিক আগের বাড়ির জমানো মোট টাকাই হাতে থেকে যায়।max() $\rightarrow$ এই দুই রাস্তার মধ্যে যেটি বেশি টাকা দেয়, সেটি বেছে নেয়।
"""
